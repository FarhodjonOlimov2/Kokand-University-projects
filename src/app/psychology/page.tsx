          ...
          <div className="lg:col-span-7 bg-white p-6 rounded-3xl shadow-sm border border-[#EAE6DF] flex flex-col justify-between animate-fade-in-scale">
            ...
            <div>
              <button
                ...
                className="w-full py-3.5 px-5 bg-[#1C1917] hover:bg-[#292524] text-white font-bold text-sm rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
